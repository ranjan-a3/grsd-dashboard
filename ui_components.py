...
def render_performance_chart(
    ...
    benchmark_df = _flat(benchmark_df)
    bench = benchmark_df["Close"].rename("bench") if "Close" in benchmark_df.columns else pd.Series(dtype=float) if "Close" in benchmark_df.columns else pd.Series(dtype=float)
    fig   = go.Figure()
